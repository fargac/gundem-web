export default function StoreCTA() {
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-[#08080a]/90 backdrop-blur-md border-t border-white/5 px-6 pt-3 pb-[calc(0.75rem+env(safe-area-inset-bottom))]">
